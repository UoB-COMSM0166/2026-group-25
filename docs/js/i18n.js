...
function applyLang() {
    ...
    // Achievement content is dynamically rendered, so refresh it if open.
    const achEl = document.getElementById('achPanelWrap');
    if (achEl && typeof showAchievementPanel === 'function') showAchievementPanel();
...
const TRANSLATIONS = {
    zh: {
        ...
        'ach.reward.gems':      '宝石',
        'ach.cat.combat':       '战斗',
        'ach.cat.progression':  '进度',
        'ach.cat.collection':   '收集',
        'ach.cat.arsenal':      '军械库',
        'ach.cat.survival':     '生存',
        'ach.cat.special':      '特殊',
        'ach.kill_count.name':  '杀敌者',
        'ach.kill_count.desc.1':'击杀 100 个敌人',
        'ach.kill_count.desc.2':'击杀 500 个敌人',
        'ach.kill_count.desc.3':'击杀 2000 个敌人',
        'ach.combo_king.name':  '连击之王',
        'ach.combo_king.desc.1':'达到 10 连击',
        'ach.combo_king.desc.2':'达到 30 连击',
        'ach.combo_king.desc.3':'达到 60 连击',
        'ach.boss_hunter.name': 'Boss 猎人',
        'ach.boss_hunter.desc.1':'击败 5 个 Boss',
        'ach.boss_hunter.desc.2':'击败 20 个 Boss',
        'ach.boss_hunter.desc.3':'击败 50 个 Boss',
        'ach.mega_slayer.name': '巨型 Boss 终结者',
        'ach.mega_slayer.desc.1':'击败 1 个巨型 Boss',
        'ach.final_showdown.name':'最终决战',
        'ach.final_showdown.desc.1':'击败第 66 波双 Boss',
        'ach.wave_surfer.name': '浪潮征服者',
        'ach.wave_surfer.desc.1':'到达第 10 波',
        'ach.wave_surfer.desc.2':'到达第 30 波',
        'ach.wave_surfer.desc.3':'到达第 60 波',
        'ach.veteran.name':     '老兵',
        'ach.veteran.desc.1':   '达到等级 10',
        'ach.veteran.desc.2':   '达到等级 20',
        'ach.veteran.desc.3':   '达到等级 30',
        'ach.score_chaser.name':'分数追逐者',
        'ach.score_chaser.desc.1':'获得 500 分',
        'ach.score_chaser.desc.2':'获得 3000 分',
        'ach.score_chaser.desc.3':'获得 10000 分',
        'ach.victory.name':     '胜利',
        'ach.victory.desc.1':   '完成关卡 1',
        'ach.hell_conqueror.name':'地狱征服者',
        'ach.hell_conqueror.desc.1':'关卡 2 到达第 20 波',
        'ach.hell_conqueror.desc.2':'关卡 2 到达第 50 波',
        'ach.hell_conqueror.desc.3':'关卡 2 到达第 88 波',
        'ach.gold_rush.name':   '淘金热',
        'ach.gold_rush.desc.1': '累计获得 200 金币',
        'ach.gold_rush.desc.2': '累计获得 1000 金币',
        'ach.gold_rush.desc.3': '累计获得 5000 金币',
        'ach.gem_collector.name':'宝石收藏家',
        'ach.gem_collector.desc.1':'累计获得 30 宝石',
        'ach.gem_collector.desc.2':'累计获得 150 宝石',
        'ach.gem_collector.desc.3':'累计获得 500 宝石',
        'ach.treasure_run.name':'宝藏冲刺',
        'ach.treasure_run.desc.1':'单局收集 80+ 金币',
        'ach.first_upgrade.name':'首次升级',
        'ach.first_upgrade.desc.1':'购买第一个武器升级',
        'ach.full_arsenal.name':'全副武装',
        'ach.full_arsenal.desc.1':'3 把武器全部升到 Lv3',
        'ach.quantum_era.name': '量子时代',
        'ach.quantum_era.desc.1':'解锁量子手枪',
        'ach.talent_master.name':'天赋大师',
        'ach.talent_master.desc.1':'购买 5 级天赋',
        'ach.talent_master.desc.2':'购买 15 级天赋',
        'ach.iron_fortress.name':'钢铁堡垒',
        'ach.iron_fortress.desc.1':'护甲升至满级 Lv3',
        'ach.army_builder.name':'军团建设者',
        'ach.army_builder.desc.1':'最高兵力达到 30',
        'ach.army_builder.desc.2':'最高兵力达到 50',
        'ach.army_builder.desc.3':'最高兵力达到 80',
        'ach.no_casualties.name':'零伤亡',
        'ach.no_casualties.desc.1':'Boss 波次中无兵力损失',
        'ach.phoenix_rising.name':'凤凰涅槃',
        'ach.phoenix_rising.desc.1':'复活后完成关卡',
        'ach.iron_will.name':   '钢铁意志',
        'ach.iron_will.desc.1': '第 25 波以上、0 次复活、损失不超过 3 名士兵',
        'ach.chain_reaction.name':'连锁反应',
        'ach.chain_reaction.desc.1':'触发 3+ 油桶连锁爆炸',
        'ach.speed_kill.name':  '速杀',
        'ach.speed_kill.desc.1':'Boss 出现后 5 秒内击杀',
        'ach.marathon.name':    '马拉松',
        'ach.marathon.desc.1':  '游玩 10 局',
        'ach.marathon.desc.2':  '游玩 30 局',
        'ach.marathon.desc.3':  '游玩 100 局',
        'ach.perfectionist.name':'完美主义者',
        'ach.perfectionist.desc.1':'解锁所有其他成就（满阶）',
