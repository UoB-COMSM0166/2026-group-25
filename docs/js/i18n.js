...
const TRANSLATIONS = {
    ...
    en: {
        ...
        'shop.advice.title':    'Smart Suggestions',
        'shop.advice.tag.unlock':'Unlock',
        'shop.advice.tag.save': 'Save',
        'shop.advice.tag.power':'Power',
        'shop.advice.tag.progress':'Progress',
        'shop.advice.tag.ready':'Ready',
        'shop.advice.tag.balance':'Balance',
        'shop.advice.tag.variety':'Variety',
        'shop.advice.tag.survival':'Survival',
        'shop.advice.tag.core':'Core',
        'shop.advice.weapon.buyNow':'You can unlock {0} now for a stronger base run.',
        'shop.advice.weapon.saveFor':'Save {1} more coins for {0}. It is your best unlocked upgrade right now.',
        'shop.advice.weapon.equipBetter':'You already own {0}. Equip it before your next run for a free power bump.',
        'shop.advice.weapon.levelGate':'Reach Lv.{0} next. You are only {1} level(s) away from the next base weapon.',
        'shop.advice.weapon.setForNow':'Your current base weapon is in a good spot. Save up for the next unlock.',
        'shop.advice.special.buyNow':'Buy {0} Lv.{1} now to improve your next weapon gate payoff.',
        'shop.advice.special.saveFor':'Save a bit more for {0}. It is one of your weakest permanent weapon upgrades.',
        'shop.advice.special.loadout':'Loadout Coverage',
        'shop.advice.special.balance':'Keep your special weapons close in level so every gate stays worth taking.',
        'shop.advice.special.variety':'Unlock at least two special weapons so more gate spawns can turn into real power spikes.',
        'shop.advice.talent.buyNow':'You can buy {0} now for a reliable permanent boost every run.',
        'shop.advice.talent.saveFor':'Save {1} more gems for {0}. It is one of your most underleveled talents.',
        'shop.advice.talent.complete':'Talent Progress',
        'shop.advice.talent.maxed':'Your core talents are maxed. Future gems can be saved for revive flexibility.',
        'shop.advice.defense.shieldNow':'Buy a Shield charge now. It is the safest panic button for boss mistakes.',
        'shop.advice.defense.shieldSave':'Save {0} more coins for a Shield charge so you always have one defensive reset.',
        'shop.advice.defense.frenzyNow':'Buy Frenzy now if you want a bigger push through hard waves or bosses.',
        'shop.advice.defense.frenzySave':'Save {0} more coins for Frenzy to keep one burst option ready.',
        'shop.advice.defense.stocked':'Skill Stock Ready',
        'shop.advice.defense.covered':'You already have defensive and burst tools stocked. Spend coins elsewhere if needed.',
